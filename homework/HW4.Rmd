...
library(readstata13)
library(geniusr)
Dow <- read_csv("~/canyon-foot/homework/HistoricalPrices.csv")
Logs <- read_csv("~/canyon-foot/homework/LogPricesFiltered.csv")
Counties <- read.dta13("http://www.equality-of-opportunity.org/data/neighborhoods/online_table4.dta", encoding = "windows-1252")
```
